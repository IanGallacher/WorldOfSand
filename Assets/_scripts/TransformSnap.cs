...
{	
	...
	public static TransformSnap SnapToClosest(GameObject subject,
											  List<GameObject> targets,
											  float maximumSquaredDistance = 0) {
	...
	public static GameObject GetClosestObject(GameObject subject,
											  List<GameObject> targets,
											  float maximumSquaredDistance = 0) {
		return GetClosestObject(subject.transform.position, targets, maximumSquaredDistance);
	}
	
	public static GameObject GetClosestObject(Vector3 currentPosition,
											  List<GameObject> targets,
											  float maximumSquaredDistance = 0) {
